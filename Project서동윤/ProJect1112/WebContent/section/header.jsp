...
<body>
	<nav class="navber">
				...
				<c:when test="${empty sessionScope.login_Name}">
					<ul class="nav__Login">
						<li><a href="../Member/mainLoginPage.jsp"><i
								class="fas fa-sign-in-alt"></i><br>Login</a></li>
						<li><a href="../Member/signupPage.jsp"><i
								class="fas fa-user-plus" style="margin-left: 6.5px;"></i><br>Join</a></li>
					</ul>
				</c:when>
				<c:otherwise>
					<ul class="nav__Login">
						<li style="color: white;"><a href="../Member/MyPage.so"><i
								class="fas fa-users"></i><br>MyPage</a></li>
						<li><a href="../logout.so" onclick="return logout();"><i
								class="fas fa-sign-out-alt" style="margin-left: 5px;"></i><br>Logout</a></li>
						<li><a href="../cart/cartSelect.co"><i
								class="fas fa-shopping-cart" style="margin-left: 2.5px;"></i><br>Cart</a></li>
						<li><a href="../order/orderSelect.co"><i
								class="fas fa-money-check-alt" style="margin-left: 2px;"></i><br>Order</a></li>
					</ul>
				</c:otherwise>
			</c:choose>
		</div>
		<div class="menu">
			...
			<li><a href="../Board/board.bo">Board</a></li>
		</div>
